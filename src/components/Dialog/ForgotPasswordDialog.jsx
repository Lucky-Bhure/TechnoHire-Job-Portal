  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-white">
      ...
      <div className="w-full md:w-[60%] h-screen md:h-auto px-6 py-8 md:px-12 lg:px-32 sm:px-32 xs:px-12 rounded-lg">
        ...
        <p className="text-center mt-0 mb-[40px] text-gray-500 text-xl">Enter your registered email to receive a password reset link</p>
        ...
        Go back to {" "}
          ...
          <div className="flex justify-center">
            ...
            >
              <span className="text-lg">Reset Password</span> <i className="fa-solid fa-arrow-right mx-3 text-lg"></i>
            </button>
          </div>
        </form>
