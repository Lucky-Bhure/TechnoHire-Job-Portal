...
const SignUp = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      password: "",
      confirmPassword: "",
      // mobileNumber: "" // Commented out as requested
    },
    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.post(
          "https://job-portal-candidate-be.onrender.com/v1/registration/",
          {
            fullName: values.fullName,
            userName: values.username,
            // mobileNumber: values.mobileNumber, // Commented out
            email: values.email,
    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="left-side w-full md:w-3/5 overflow-y-hidden scrollbar-hide bg-white px-20 pt-5">
        ...
        <form onSubmit={formik.handleSubmit} className="w-full mt-5">
          ...
          {/* Mobile Number Field (Commented Out) */}
          {/* <div className="mb-4">
            <input
              type="text"
              name="mobileNumber"
          ...
          <button
            ...
            className="w-[16rem] h-[64px] flex justify-center items-center my-6 py-3 text-white bg-violet hover:bg-purple-800 rounded-md disabled:opacity-50"
          >
          ...
          <a href="https://accounts.google.co.in/">
            <button className="p-0 bg-gray-100 text-white rounded-md w-[105px] h-[56px] flex justify-center items-center">
              ...
              >
                ...
                />
                <path
                  d="M20.5442 4.08026L16.7156 7.21467C15.6383 6.54131 14.3649 6.15232 14.0007 6.15232C9.92014 6.15232 7.3026 8.13542 6.35456 10.8946L2.50455 7.74261H2.50391C4.4708 3.9504 8.43313 1.3595 14.0007 1.3595C15.8682 1.3595 18.4974 2.38094 20.5442 4.08026Z"
                  fill="#F14336"
                />
              </svg>
            </button>
