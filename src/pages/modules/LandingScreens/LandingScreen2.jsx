    ...
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-white">
      ...
      <div className="w-full md:w-[60%] px-6 py-8 sm:px-10 lg:px-20 flex flex-col items-center md:items-start">
        ...
        Find a job that suits your  <br />
          <span style={{ color: "#7900BA" }}>finding jobs Interest </span>
          & <span style={{ color: "#7900BA" }}>Skills</span>
        </h2>
        ...
        <div className="flex flex-col items-center md:items-start text-center mb-8">
          ...
          Explore exciting opportunities tailored to your expertise {" "}and passions. Start 
            <span style={{ color: "#7900BA" }}> your journey </span> toward{" "}
            <span style={{ color: "#7900BA" }}>a career that truly fits you! </span> 
          </p>
        </div>
