...
const Inboxes = () => {
  ...
  return (
    <>
      <Header />
      <div className="flex gap-4 justify-center items-start ml-16 mt-20">
        <div className="w-[870px] h-[920px] overflow-hidden rounded-[10px] border-2">
          <div className="flex gap-6 flex-col bg-[#C9C5C51A] h-[165px]">
            <div className="flex gap-10 items-center pl-6 pr-6 pt-6">
              <h5 className="font-medium font-inter text-[#00000060] text-[21px]">
                Inbox
              </h5>
            ...
            <div className="flex justify-center gap-12">
              <button
                className={`w-[112px] h-[42px] border-2 ${
                  !showUnread && !showSpam && !showStarred
                    ? "bg-[#7900BA] text-[#FFFFFF]"
                    : "border-[#939393] text-[#3A3434]"
                } rounded-[10px]`}
                onClick={() => {
                  setShowUnread(false);
                  setShowSpam(false);
          ...
          {/* 👇 Updated height here */}
          <div className="flex h-[755px] overflow-hidden">
            <MessageList
        ...
        <div className="flex flex-col gap-24">
          <div className="border-2 w-[380px] h-[248px] rounded-xl flex justify-center items-center relative shadow-lg">
            <img
              className="w-[380px] h-[248px] rounded-xl"
              src={messageSideImage}
              alt="Image"
            />
            <div>
          ...
          <div className="flex flex-col">
            <div className="border-2 w-[380px] h-[341px] p-4 rounded-lg">
              <h4 className="text-[18px] text-[#000000] font-inter font-bold leading-[28px]">
                Get hire faster with Premium
              </h4>
              <p className="text-[18px] leading-[28px] font-medium text-[#615C5C]">
              ...
              <div className="flex gap-3 mb-5 mt-5">
                ...
                <p className="font-normal text-[15px] font-inter leading-[28px]">
                  Rekha and millions of other <br /> members use Premium
                </p>
              </div>
              <button
                className="ml-14 flex p-4 mb-5 font-bold bg-[#F6C57D] rounded-full text-[#323F4E] text-[20px]"
                type="button"
              >
                Try Premium for
              </button>
              <p className="text-[#00000080] text-[13px]">
                1-month free trial. We’ll send you a reminder 7 days <br />
